...
namespace ZyronChat.Data.Migrations
{
    ...
    [Migration("20221016005120_RemovedAInheritanceOfMessagesModel")]
    partial class RemovedAInheritanceOfMessagesModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZyronChatWebApp.Models.ChatMessages", b =>
                {
                    ...
                    b.HasKey("IdUserSender", "IdUserReceiver");
            ...
            modelBuilder.Entity("ZyronChatWebApp.Models.Messages", b =>
                {
                    ...
                    b.Property<string>("ChatMessagesIdUserReceiver")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("ChatMessagesIdUserSender")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("ChatMessagesIdUserSender", "ChatMessagesIdUserReceiver");
            ...
            modelBuilder.Entity("ZyronChatWebApp.Models.Messages", b =>
                {
                    b.HasOne("ZyronChatWebApp.Models.ChatMessages", null)
                        .WithMany("MessagesList")
                        .HasForeignKey("ChatMessagesIdUserSender", "ChatMessagesIdUserReceiver");
                });
